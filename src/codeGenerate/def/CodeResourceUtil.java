...
{
  private static final ResourceBundle bundle = ResourceBundle.getBundle("resources/jeecg/jeecg_database");
  private static final ResourceBundle bundlePath = ResourceBundle.getBundle("resources/jeecg/jeecg_config");
  ...
  public static String source_xml_package = "resource";
  ...
  static
  {
    ...
    source_xml_package = getSource_xml_package();
    ...
    source_xml_package = source_xml_package.replace(".", "/");
  ...
  private static String getProjectPath() {
	  return bundlePath.getString("project_path");
  }
  ...
  public static final String getSource_xml_package()
  {
	  return bundlePath.getString("source_xml_package");
  }
