...
import com.controller.BaseAction;
import com.road7.vrm.util.HtmlUtil;
import com.entity.BaseEntity.DELETED;
import com.entity..IpkCard;
import com.page..IpkCardPage;
import com.service..IpkCardService;
 ...
 * <b>日期：</b> Wed Nov 18 10:25:19 CST 2015 <br>
...
public class IpkCardController extends BaseAction{
	...
	public ModelAndView  list(IpkCardPage page,HttpServletRequest request) throws Exception{
		...
		return forword("com//ipkCard",context); 
	}
